	...
	<script src="${APP_PATH}/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#updateBtn").click(function(){
            	...
            	if(loginacct==""){
            		layer.msg( "登录账号不能为空，请输入", {time:3000, icon:5, shift:5}, function(){ });
            		return;
            	}  
            	var userName = $("#userName").val();
            	if(userName==""){
            		layer.msg( "用户名不能为空，请输入", {time:3000, icon:5, shift:5}, function(){ });
            		return;
            	}
            	...
            	$.ajax({
            		...
            		beforeSend:function(){
              		...
              		success:function(result){
              			...
              			if(result.success){
              				layer.msg( "用户信息修改成功！", {time:3000, icon:6}, function(){ });
              				window.location.href="${APP_PATH}/user/index";
              			}else{
              				layer.msg( "用户信息修改失败！", {time:3000, icon:5, shift:5}, function(){ });
              			}
              		}
            	});
            });
