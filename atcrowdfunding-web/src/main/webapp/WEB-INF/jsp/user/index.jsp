	...
	<script src="${APP_PATH}/layer/layer.js"></script>
        ...
        var likeflag =false;
            	...
            	$.ajax({
             	   ...
             	   success:function(result){
               			...
               			if(result.success){
               				...
               				layer.msg( "用户信息分页查询失败", {time:3000, icon:5, shift:5}, function(){ });
               			}
             	   }
            	});
            }
            ...
            function deleteUser(id,loginacct){
            	layer.confirm("确认删除用户："+loginacct+"?",  {icon: 3, title:'提示'}, function(cindex){
    			    //删除用户信息
    			    $.ajax({
	            		type:"POST",
	             	   ...
	             	   success:function(result){
	               			...
	               			if(result.success){
	               				...
	               				layer.msg( "用户信息删除失败", {time:3000, icon:5, shift:5}, function(){ });
	               			}
	             	   }
	            	});
            		layer.close(cindex);
           ...
           function deleteUsers(){
        	   ...
        	   return;
        	   if(boxes.length ==0){
        		   layer.msg( "没有选择用户！", {time:3000, icon:5, shift:5}, function(){ });
        	   }else{
        		   alert($("#userForm").serialize());
